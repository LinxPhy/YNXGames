        ...
        <div className={styles.faq}>
            ...
            <div className={styles.content}>
                <div className={styles.section}>
                    ...
                    <p>
                        YNXGames stands for Your Next Games - it is a website with the primary goal of helping you find the next game you want to play. <br /><br />
                        The reason why this website exists is to help people find a game they might enjoy, our goal is to make it easy for users to find what they want and to do it as quickly as possible. <br /><br />
                ...
                <div className={styles.section}>
                    ...
                    <p>
                        YNXGames makes use of external source for its data. If an error is encountered, it could be due to the data collected from these sources. <br /><br />
                        If that is the case, we may not be able to sort out the issue however we will do our best to fix it where possible. <br /><br />
                ...
                <div className={styles.section}>
                    ...
                    <p>
                        If you are unable to find the game you are looking for in our database, we suggest using deep search to find the game. <br /><br />
